...
Baseline LightGBM classifier operating strictly on raw tabular features.
"""
...
class BaselineClassifier:
    """LightGBM tabular classifier benchmark (M0)."""
    ...
    def _prepare_data(self, df: pd.DataFrame) -> Tuple[np.ndarray, np.ndarray]:
        # Exclude tracking and target columns
    ...
    def train(self, train_df: pd.DataFrame, val_df: pd.DataFrame) -> None:
        ...
        # Scale positive weight based on training prevalence
